...
func TestHostWiring(t *testing.T) {
	...
	if want := "dadjoke://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("dadjoke", "about")
	if err != nil || got.String() != "dadjoke://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want dadjoke://page/about", got.String(), err)
	}
}
